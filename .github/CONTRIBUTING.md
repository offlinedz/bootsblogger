# Contributing to Bootsblogger

Looking to contribute something to Bootsblogger? **Here's how you can help.**
...
The [issue tracker](https://github.com/bootsblogger/bootsblogger/issues) is
...
- `confirmed` - Issues that have been confirmed with a reduced test case and identify a bug in Bootsblogger.
...
- `template` - Issues stemming from our compiled or source template files.

For a complete look at our labels, see the [project labels page](https://github.com/bootsblogger/bootsblogger/labels).
...
3. **Isolate the problem** &mdash; ideally create a [reduced test
   ...
   [This JS Bin](https://jsbin.com/terusul/edit?html,output) is a helpful template.
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/bootsblogger.git
   # Navigate to the newly cloned directory
   cd bootsblogger
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/bootsblogger/bootsblogger.git
   ```
